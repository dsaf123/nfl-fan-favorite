...
/// @nodoc
mixin _$Position {
  PositionDescription? get position => throw _privateConstructorUsedError;
  List<DepthchartAthlete> get athletes => throw _privateConstructorUsedError;
...
abstract class $PositionCopyWith<$Res> {
  ...
  @useResult
  $Res call({PositionDescription? position, List<DepthchartAthlete> athletes});

  $PositionDescriptionCopyWith<$Res>? get position;
}
...
class _$PositionCopyWithImpl<$Res, $Val extends Position>
  ...
  $PositionDescriptionCopyWith<$Res>? get position {
    ...
    return $PositionDescriptionCopyWith<$Res>(_value.position!, (value) {
...
class _$PositionImpl extends _Position {
  _$PositionImpl(
      {required this.position, required final List<DepthchartAthlete> athletes})
      : _athletes = athletes,
        super._();
  ...
  @override
  final PositionDescription? position;
  final List<DepthchartAthlete> _athletes;
  @override
  List<DepthchartAthlete> get athletes {
  ...
  @override
  String toString() {
    return 'Position(position: $position, athletes: $athletes)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, position, const DeepCollectionEquality().hash(_athletes));
...
abstract class _Position extends Position {
  factory _Position(
      {required final PositionDescription? position,
      required final List<DepthchartAthlete> athletes}) = _$PositionImpl;
  _Position._() : super._();
  ...
  @override
  PositionDescription? get position;
  @override
  List<DepthchartAthlete> get athletes;
